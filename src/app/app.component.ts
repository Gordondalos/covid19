      ...
      fieldGroup: [
        {
          ...
          templateOptions: {
            ...
            options: [
              { label: 'Есть', value: 1 },
              { label: 'Болит немного', value: 0.5 },
              { label: 'Болит иногда', value: 0.2 },
              { label: 'Нет', value: 0 },
            ],
          },
        },
        {
          ...
          templateOptions: {
            ...
            options: [
              { label: 'Есть', value: 1 },
              { label: 'Часто', value: 0.5 },
              { label: 'Иногда', value: 0.2 },
              { label: 'Нет', value: 0 },
            ],
          },
        },
